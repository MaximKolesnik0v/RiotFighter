...
{
    public class RedEnemyController : BaseController
    {
        ...
        public RedEnemyController(IView view)
        {
            ...
            _enemyModelData = enemyData.Enemies
                .Where(i => i.type == EnemyType.REDENEMY)
            ...
            _model = new RedEnemyModel(_enemyModelData);
        ...
        private void RedEnemyAI(float time)
        {
